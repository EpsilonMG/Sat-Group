...
def predict():
    ...
    comp_mean=float(all_data['comp_mean']) 
    ...
    ,comp_mean ,callfwd_mean,callwait_mean,months,totcalls,totmou ,totrev,adjrev,adjmou,adjqty
    ...
    data_final=list(data[0:5])+[data[6]]+[data[11]]+[data[16]]+[data[17]]
    pred=model.predict(np.array([data_final]))[0]
